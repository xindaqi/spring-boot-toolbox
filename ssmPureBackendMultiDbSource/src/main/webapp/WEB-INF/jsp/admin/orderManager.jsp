...
<html>
  <head>
    <base href="<%=basePath%>">
    <title>订单管理</title>
	<link href="<%=path%>/resource/static/css/admin/common.css" type="text/css" rel="stylesheet">
	<style type="text/css">
		table{
			text-align: center;
	...
	<script type="text/javascript">
		...
		function checkDel(id){
  			if(window.confirm("是否删除该订单？")){
  				window.location.href="/online-shopping-testversion/adminOrder/deleteorderManager?id="+id;
  			}
  		}
	</script>
</head>
