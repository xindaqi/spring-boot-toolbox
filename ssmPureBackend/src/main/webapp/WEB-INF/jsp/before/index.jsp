				...
				<div class="box_2">
					...
					<div class="top10List clearfix">
						<c:forEach items="${salelist }" var="sg" varStatus="status">
							<ul class="clearfix">
								<img class="iteration" src="<%=path%>/resource/static/images/before/top_${status.index+1 }.gif" />
								<li class="topimg">
		...
		<div class="AreaR">
			<div class="AreaR">
				<div class="AreaM clearfix">
					<div id="focus">
						<img src="<%=path%>/resource/static/images/before/540.jpg" />
					</div>
				</div>
						...
						<div class="box_1">
							...
							<div class="post_list ared">
								...
								<c:forEach items="${noticelist}" var="nt">
									<li><a href="javascript:openNotice('/online-shopping-testversion/selectANotice?id=${nt.id }');">${nt.ntitle }</a></li>
								</c:forEach>
								</ul>
							</div>
						</div>
