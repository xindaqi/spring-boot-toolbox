...
<base href="<%=basePath%>">
<title>购物车</title>
<link href="<%=path%>/resource/static/css/before/daohang.css" rel="stylesheet" type="text/css" />
<link href="<%=path%>/resource/static/css/before/common.css" rel="stylesheet" type="text/css" />
<link href="<%=path%>/resource/static/css/before/style.css" rel="stylesheet" type="text/css" />
<script type="text/javascript">
	//确认
	function  goOrderConfirm(){
		window.location.href="/online-shopping-testversion/cart/orderConfirm";
	}
	//清空
	function godelete(){
		if(window.confirm("真的清空购物车吗？")){
			window.location.href="/online-shopping-testversion/cart/clear";
			return true;
		}
		return false;
	}
	...
	function deleteAgoods(gno){
		if(window.confirm("真的删除该商品吗？")){
			window.location.href="/online-shopping-testversion/cart/deleteAgoods?id=" + gno;
			return true;
		}
		return false;
	}
				...
				<table width="99%" align="center" border="0" cellpadding="5"
					...
					<c:forEach var="ce" items="${cartlist}"> 
						<tr>
							...
							<td align="center" bgcolor="#ffffff" width="185px"><a
								...
								class="f6" title="删除"><img src="<%=path%>/resource/static/images/before/sc.png" />
							</a></td>
						</tr>
					</c:forEach>
					<tr>
					...
					<tr>
						<td bgcolor="#ffffff" colspan="4" align="right"
							...
							<a href="before"> <img src="<%=path%>/resource/static/images/before/jxgw.jpg" alt="continue" />
						</a>
						</td>
						<td bgcolor="#ffffff" align="center"
							style="border-left: 0 none; padding: 5px; padding-right: 2px;">
							<a style="cursor: pointer;" href="javascript:goOrderConfirm()">
								<img src="<%=path%>/resource/static/images/before/qjs.jpg" alt="checkout" />
						</a>
						</td>
					</tr>
				</table>
